        ...
        <el-col :span="8" :xs="24">
            <el-card>
                <el-form>
                    ...
                    <x-select exp="model:form.categoryId;label:分类;key:id;selectLabel:name;value:id;data:categories" />
                    <x-select exp="model:form.userId;label:用户;key:id;selectLabel:name;value:id;data:users" />

...
<div id="app">
    ...
    <el-container style="height: 100%;width: 100%;">
        ...
        <el-header style="width: 100%;height: 60px;padding: 0;">

            <el-menu style="height: 100%;width: 100%" :default-active="menuActive" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" mode="horizontal">
